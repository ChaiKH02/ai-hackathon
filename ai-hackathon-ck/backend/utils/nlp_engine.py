...
def get_sentiment_label(sentiment_score: int) -> str:
    ...
    NOTE: This is a fallback function. The AI now determines sentiment labels directly.
...
def combined_nlp_pipeline(df_path: str) -> str:
    ...
    try:
        ...
        for original_text in df_subset['Comments']:
            ...
            # 3E: Evaluate sentiment (AI now determines both score and label)
...
def ai_evaluate_sentiment(cleaned_comment: str) -> SentimentResponse:
    """
    Uses AI to evaluate both sentiment score and label from a professionally rewritten comment.
    The AI determines the sentiment classification directly based on the comment content.
    
    Args:
        cleaned_comment: The rephrased/cleaned English comment from combine_nlp_pipeline
        
    Returns:
        SentimentResponse with sentiment_score (1-10) and sentiment_label (negative/neutral/positive)
    """
...
"""
    ...
    try:
        ...
        # Return neutral score and label on error
