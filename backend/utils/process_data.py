...
from utils.nlp_engine import combined_nlp_pipeline, ai_rephrase, ai_extract_categories, ai_evaluate_sentiment
import malaya
import inspect
...
def process_single_comment(original_text, corrector, transformer):
    ...
    Returns:
        dict with rephrased, categories, and sentiment_score
    """
    # Skip empty comments
...
def process_csv_data(input_csv_path: str, output_csv_path: str):
    ...
    sample_cols = ['Submission_Date', 'Quarter', 'Event_Season', 
                   'Comments', 'Rephrased_Comment', 'Categories', 'Sentiment_Score']
